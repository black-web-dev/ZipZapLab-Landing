...
const cardData = [
  {
    color: '#000000',
    title: 'Telegram + сайт',
    description: 'Единая логика поддержки в Telegram и веб‑виджете.',
    label: 'Каналы'
  },
  {
    color: '#000000',
    title: 'FAQ‑first',
    description: 'Эталонные ответы экспертов приоритетнее генерации.',
    label: 'Качество'
  },
  {
    color: '#000000',
    title: 'RAG с цитатами',
    description: 'Ссылки на первоисточник и прозрачная проверяемость.',
    label: 'Знания'
  },
  {
    color: '#000000',
    title: 'Эскалации оператору',
    description: 'Маршрутизация по правилам, пороги и SLA‑контроль.',
    label: 'SLA'
  },
  {
    color: '#000000',
    title: 'Метрики и алерты',
    description: 'Prometheus/Grafana: качество, скорость, нагрузка, ошибки.',
    label: 'Наблюдаемость'
  },
  {
    color: '#000000',
    title: 'Роли и аудит',
    description: 'Права доступа, журнал действий и защита данных.',
    label: 'Безопасность'
  }
];
