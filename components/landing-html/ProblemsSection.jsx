...
const problems = [
  {
    ...
    problemDesc:
      "Одни и те же вопросы отнимают время, которое нужно для сложных кейсов.",
    solution: "Агент закрывает типовые обращения",
    solutionDesc:
      "Telegram и web‑виджет работают 24/7, операторы подключаются только к сложным.",
  },
  {
    problem: "Модель «фантазирует»",
    problemDesc:
      "LLM выдаёт уверенные, но ложные ответы — пользователь разочарован.",
    solution: "Коэффициенты семантической близости отсекают нерелевантное",
    solutionDesc:
      "Валидация вопроса и настраиваемая семантическая близость гарантируют опору на источники.",
  },
  {
    ...
    solutionDesc:
      "SLA‑дашборд показывает, кто из операторов-экспертов не отвечает, и напоминает руководителю.",
  },
];

export default function ProblemsSection() {
  return (
    <section id="problems" className="bg-slate-50 py-12 sm:py-20 text-slate-900">
            ...
            <Reveal key={item.problem}>
              <div className="h-full rounded-xl border border-slate-200 bg-white p-6 shadow-lg shadow-black/5">
                <div className="flex flex-col min-h-[170px]">
                  ...
                  <div className="py-4 text-center text-2xl text-cyan-500">
                    ↓
                  </div>
                </div>
